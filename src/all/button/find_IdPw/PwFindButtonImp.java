...
public class PwFindButtonImp implements PwFindButton {
	...
	public void pwFindProc(Parent root) {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/find_IdPw/pwFind.fxml"));
	...
	public void findPwResult(Parent root, String pw, String findName) {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/find_IdPw/pwFindResult.fxml"));
