...
//		    			ImageView sellImageView1 = (ImageView)root.lookup("#SellgBoardImage1");
//		    			ImageView sellImageView2 = (ImageView)root.lookup("#SellBoardImage2");
//		    			if(!(sellLatestImage1.isEmpty())) {
//		    				Image sellImage1 = sellLatestImage1.get(0);
//		    				sellImageView1.setImage(sellImage1);
//		    			}
//		    			if(!(sellLatestImage2.isEmpty())) {
//		    				Image sellImage2 = sellLatestImage2.get(0);
//		    				sellImageView2.setImage(sellImage2);
//		    			}
//		    			
